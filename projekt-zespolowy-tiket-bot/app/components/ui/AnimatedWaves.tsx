...
export default function AnimatedWaves() {
  return (
    ...
    <div className="absolute inset-0 z-0 overflow-hidden bg-gray-950 pointer-events-none">
      ...
      <div className="absolute bottom-[-10%] left-[-50%] w-[200%] h-[50vh] md:h-[60vh]">
        
        {/* Pierwsza fala - ciemniejsza, wolniejsza, pod spodem */}
        <div 
          className="absolute top-0 left-[50%] w-[150vw] h-[150vw] max-w-[2000px] max-h-[2000px] ml-[-75vw] max-md:ml-[-1000px] rounded-[43%] bg-indigo-900/30 animate-wave-slow"
        />
        
        {/* Druga fala - jaśniejsza, szybsza, lekko przesunięta, na wierzchu */}
        <div 
          className="absolute top-[5%] left-[50%] w-[140vw] h-[140vw] max-w-[1900px] max-h-[1900px] ml-[-70vw] max-md:ml-[-950px] rounded-[40%] bg-indigo-600/20 animate-wave-fast"
        />
